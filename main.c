...
//Binary yazdirmak icin void fonksiyonu eklendi
...
int main() {
    ...
    if (isdigit(c1) && isdigit(c2)) {
        ...
        char rakam1 = c1 -'0';
        char rakam2 = c2 -'0';
        char rakam_toplam =(rakam1+rakam2)& 0b111111;; //(0b111111)6-bit siniri uygulanarak overflow davranışı simule edildi
        ...
        if (rakam_toplam > 9) {
            ...
            //  Rakam toplaminin 6-bit'e sigip sigmadigini kontrol et
